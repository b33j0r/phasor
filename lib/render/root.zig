...
pub const CoreShaders = struct {
    ...
    sky_procedural_atmospheric: ShaderHandle = ShaderHandle.invalid(),
...
pub const ShapesModule = shape.ShapesModule;
pub const Circle = shape.Circle;
pub const Rectangle = shape.Rectangle;
pub const GeneratedMeshKey = shape.GeneratedMeshKey;
pub const GeneratedMeshCache = shape.GeneratedMeshCache;
pub const GeneratedMeshInstance = shape.GeneratedMeshInstance;
