        ...
        "examples": [
            {
                ...
                "wasm_build_step": example.wasm_build_step,
                "wasm_run_step": example.wasm_run_step,
                "local_run_step": example.local_run_step,
                "local_wasm_build_step": example.local_wasm_build_step,
                "local_wasm_run_step": example.local_wasm_run_step,
