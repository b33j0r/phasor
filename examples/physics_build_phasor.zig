...
pub fn buildExample(b: *std.Build, options: BuildOptions) void {
    ...
    const phasor_physics_fps = phasor_physics_dep.module("phasor_physics_fps");
...
fn addWebBundle(
    ...
    const wasm_phasor_physics_fps = wasm_phasor_physics_dep.module("phasor_physics_fps");
    ...
    wasm_imports.append(b.allocator, .{
        .name = "phasor_physics_fps",
        .module = wasm_phasor_physics_fps,
    }) catch unreachable;
